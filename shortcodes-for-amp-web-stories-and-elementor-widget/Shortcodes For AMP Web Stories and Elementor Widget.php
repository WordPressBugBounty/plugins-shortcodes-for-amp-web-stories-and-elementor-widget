<?php
/**
 * Plugin Name: Shortcodes For AMP Web Stories and Elementor Widget
 * Description: Web Stories Shortcodes for recent Story [Recent-stories column="3" show-button="yes" show-no-of-story="all" button-text="Default view" order="DESC" btn-color="#8BCDA0" btn-text-color="#000"].
